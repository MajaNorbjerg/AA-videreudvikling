...
var pricatMNJ = [
  ...
  "Syracuse;HLZ151256;2019112119351754;NO_READ;1;15;5;;;;;;",
  "Rochester;HLZ151256;2019112119351754;NO_READ;1;15;3;;;;;;"
];
...
doc.text('Company name', 40, 110);
doc.text('Date:' + ' ' + today, 450, 110)
doc.text('Company adress', 40, 130)
doc.text('Company adress', 40, 150)

jsPDF.autoTableSetDefaults({
  StyleDef: {fontSize:8, elementHandler}, 
  startY:250,
  headStyles: {fillColor:[64,104,127]},
  bodyStyles: {fillColor:[238,241,246]},
  })
  

doc.autoTable({html:'#AATable', columnStyles: {
  0: {fontSize:0},
  1: {cellWidth: 70},
  2: {cellWidth: 50},
  3: {cellWidth: 50},
